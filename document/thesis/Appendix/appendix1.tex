...
Các siêu tham số học được tìm kiếm trong khoảng $(10^{-5}, 0.01)$ cho từng thuật toán. Kết quả tìm kiếm được trình bày trong Bảng \ref{tab:hyper_param}.
...
\begin{table}[H]
    ...
    \hline
    FedAvg, FedAvgMeta                         & $10^{-4}$          & $10^{-5}$                                      \\
    FedPer, FedPerMeta                         & $10^{-4}$          & $10^{-5}$                                      \\
