...
% ========================================================================================= %
\newcommand{\tenSV}{Nguyễn~Bảo~Long~-~Cao~Tất~Cường} % Dấu ~ là khoảng trắng không được tách (các chữ nối với nhau bằng dấu ~ sẽ nằm cùng 1 dòng
\newcommand{\mssv}{1234567}
\newcommand{\tenKL}{Meta-Learning~và~Personalization~Layer~trong~Federated~Learning} % Chú ý dấu ~ trong tên khóa luận
\newcommand{\tenGVHD}{GS.~TS.~Lê~Hoài~Bắc}
\newcommand{\tenBM}{Khoa học dữ liệu}
...
% \printbibliography[heading=subbibliography, title={Tiếng Việt}, resetnumbers=true]
