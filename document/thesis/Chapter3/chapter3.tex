...
\begin{table}[H]
    ...
    \begin{tabular}{|c|cc|}
    \hline
    \multirow{2}{*}{}    & \multicolumn{2}{c|}{Thuật toán}                                                 \\ \cline{2-3} 
                         & \multicolumn{1}{c|}{MAML}             & Meta-SGD                                \\ \hline
    Gửi tham số       & \multicolumn{1}{c|}{$w_B^t$}          & $(w_B^t, \alpha_B^t)$                   \\ \hline
    Nhận các tham số      & \multicolumn{1}{c|}{Các trọng số $w_{B(i)}^{t+1}$} & Các tham số $(w_{B(i)}^{t+1}, \alpha_{B(i)}^{t+1})$ \\ \hline
    Tổng hợp tham số  & \multicolumn{1}{c|}{$w_{B}^{t+1}$}    & $(w_{B}^{t+1}, \alpha_{B}^{t+1})$       \\ \hline
    \end{tabular}%
    }
\end{table}
